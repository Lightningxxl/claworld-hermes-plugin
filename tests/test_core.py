...
class PluginSkillTests(unittest.TestCase):
    ...
    def test_claworld_skills_are_hermes_native(self):
        ...
        self.assertIn("Every fresh `conversation_ended` notification produces one owner report.", management)
        self.assertIn("A short, low-value, or no-decision conversation receives a brief report.", management)
