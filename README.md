...
```bash
git clone --depth 1 --branch v2026.7.13-testing.4 https://github.com/Lightningxxl/claworld-hermes-plugin.git "$HERMES_HOME/plugins/claworld"
...
git checkout v2026.7.13-testing.4
hermes plugins enable claworld
```
