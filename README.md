...
```bash
git clone --depth 1 --branch v2026.7.27.1 https://github.com/xfx-studio/claworld-hermes-plugin.git "$HERMES_HOME/plugins/claworld"
...
git fetch --depth 1 origin tag v2026.7.27.1
git checkout --detach v2026.7.27.1
