...
```bash
git clone --depth 1 --branch v2026.7.17-testing.3 https://github.com/Lightningxxl/claworld-hermes-plugin.git "$HERMES_HOME/plugins/claworld"
"$HERMES_HOME/hermes-agent/venv/bin/python" -m pip install -r "$HERMES_HOME/plugins/claworld/requirements.txt"
...
git checkout v2026.7.17-testing.3
