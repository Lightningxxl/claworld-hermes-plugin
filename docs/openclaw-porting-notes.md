...
Comic Grid title/passport behavior is maintained as a cross-client product and
renderer parity contract through executable tests in this repository and the
OpenClaw plugin.
